  ...
  return (
    <section className="w-full bg-white py-16 overflow-hidden">
      <style>{`
        ...
        .about-running .border-top   {
          animation: borderDrawH 0.7s ease both;
          animation-delay: 0.05s;
        }
        .about-running .border-left  {
          animation: borderDrawV 0.6s ease both;
          animation-delay: 0.65s;
        }
        .about-running .border-right {
          animation: borderDrawV 0.6s ease both;
          animation-delay: 0.65s;
        }
      ...
      <div className="max-w-[1920px] mx-auto flex justify-center px-24">
        <div
          ref={ref}
        ...
        >
          ...
          <div className="anim-eyebrow flex items-center justify-center gap-3 mb-3">
            ...
            <span
              className="text-[10px] font-bold tracking-[0.32em] uppercase text-[#313567]"
          ...
          <h2
            className="anim-title heading-hover absolute -top-6 left-1/2 -translate-x-1/2 bg-white px-6 text-6xl font-medium text-[#313567] whitespace-nowrap cursor-default z-10"
          ...
          <div className="relative pt-10 pb-6 px-10">
            ...
            <div
              className="border-top absolute top-0 left-0 h-px bg-[#444444] rounded-tl-2xl"
              style={{ width: 0 }}
            />
            {/* Left border — draws top to bottom */}
            <div
              className="border-left absolute top-0 left-0 w-px bg-[#444444] rounded-tl-2xl"
              style={{ height: 0 }}
            />
            {/* Right border — draws top to bottom */}
            <div
              className="border-right absolute top-0 right-0 w-px bg-[#444444] rounded-tr-2xl"
              style={{ height: 0 }}
            />
          </div>
          ...
          {/* ── Paragraph ── */}
          <p
            className="anim-para text-lg text-black/80 leading-relaxed text-center max-w-4xl mx-auto"
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
          ...
          <div className="anim-para flex justify-center items-center gap-2 mt-6" style={{ animationDelay: "0.7s" }}>
