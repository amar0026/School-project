...
const Academic2 = () => {
  ...
  return (
    <section
      className="w-full min-h-screen bg-slate-50 py-14 px-4 overflow-hidden"
    ...
    >
      ...
      <div
        ref={titleRef}
        className={`px-25 mb-10 ${titleIn ? "title-r" : "title-p"}`}
      >
        {/* Eyebrow */}
        <div className="anim-up flex items-center gap-3 mb-4" style={{ animationDelay: "0s" }}>
          ...
          />
          <span className="text-[10px] font-bold tracking-[0.3em] uppercase text-indigo-900">
            Curriculum
          </span>
        </div>

        <h1
          className="anim-left hdg-hover text-3xl md:text-4xl font-bold text-indigo-900 tracking-tight cursor-default"
        ...
        <p
          className="anim-up text-slate-600 text-base md:text-lg mt-6 max-w-3xl leading-relaxed"
      ...
      <div
        ref={tableRef}
        className={`mx-25 mb-12 max-w-3xl ${tableIn ? "table-r" : "table-p"}`}
      >
        <div
        ...
        >
          {/* Card Header */}
          <div
            className="border-l-4 border-blue-600 px-6 py-4"
            style={{ background: "linear-gradient(90deg, #f8faff 0%, #f1f5f9 100%)" }}
          >
            <h2
              className="text-base md:text-lg font-bold text-slate-800"
          ...
          <div className="divide-y divide-slate-100">
            {classData.map((row, i) => (
              <div
                key={i}
                className="tile flex items-center gap-4 px-6 py-3 group"
                style={{
              ...
              >
                <span
                  className="w-32 text-slate-700 font-semibold text-sm md:text-base shrink-0"
                  style={{ fontFamily: "'DM Sans', sans-serif" }}
                >
                  {row.level}
                </span>
                <span className="text-blue-400 text-base select-none transition-transform duration-300 group-hover:translate-x-1">→</span>
                <span className="text-slate-600 text-sm md:text-base" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                  {row.age}
                </span>
              </div>
            ))}
      ...
      <div
        ref={bengaliRef}
        className={`mb-10 px-25 max-w-3xl ${bengaliIn ? "bengali-r" : "bengali-p"}`}
      >
        <div
          className="anim-left inline-flex items-center gap-2 bg-indigo-900 text-white text-sm font-semibold px-5 py-2.5 rounded-lg mb-5 tracking-wide shadow"
        ...
        <div
          className="anim-up flex flex-col gap-1 text-slate-700 text-sm md:text-base font-medium"
      ...
      {/* ── Divider ── */}
      <div className="flex items-center gap-3 max-w-3xl px-25 my-10">
      ...
      <div
        ref={englishRef}
        className={`max-w-3xl px-25 ${englishIn ? "english-r" : "english-p"}`}
      >
        <div
          className="anim-right inline-flex items-center gap-2 bg-indigo-900 text-white text-sm font-semibold px-5 py-2.5 rounded-lg mb-5 tracking-wide shadow"
          style={{ animationDelay: "0s" }}
        >
        ...
        <div
          className="anim-up flex items-center gap-3 px-4 py-3 rounded-xl max-w-xs"
          style={{
        ...
        >
          ...
          <p className="text-slate-700 font-semibold text-sm md:text-base">
            ...
            <span className="text-blue-700">08:50 A.M</span>
          </p>
        </div>
      </div>
    </section>
